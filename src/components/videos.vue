<template>
  <div class="d-flex justify-content-around flex-wrap">
    <div class="d-flex align-items-center flex-column mb-3 mx-2">
      ...
      <iframe style="border-radius: 10px" width="400" height="267" src="https://www.youtube.com/embed/xLjxbX0hbPo" title="Building Security First APIS"
        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
      </div>
      <h5 class="mt-2">FOSDEM 2024 - Brussels</h5>
    </div>
    ...
    <div class="d-flex align-items-center flex-column mb-3 mx-2">
      ...
      <h5 class="mt-2">Codemotion 2023 - Milan</h5>
    </div>
    ...
    <div class="d-flex align-items-center flex-column mb-3 mx-2">
      ...
      <h5 class="mt-2">Agile Meets Architecture 2022 - Berlin</h5>
    </div>
